...
## Что добавить перед финальной защитой

- заменить fallback HTML на React Native / React-приложение;
- добавить авторизацию и реальную модель рекомендаций;
- вынести расчёт прогнозов в отдельный сервис;
- сделать запись событий активации офферов;
- подключить дизайн-систему T и реальные UI-компоненты.
